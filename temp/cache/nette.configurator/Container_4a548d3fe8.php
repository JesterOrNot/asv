<?php
// source: /home/vottusuwu/Desktop/asv/app/config/env/prod.neon
// source: /home/vottusuwu/Desktop/asv/app/config/config.local.neon
// source: /home/vottusuwu/Desktop/asv/public/../app/config/app/nette.neon
// source: array
// source: array
...
class Container_4a548d3fe8 extends Nette\DI\Container
{
	protected $tags = [
		'middleware' => [
	...
	protected $wiring = [
		...
		'App\Module\V2\BaseV2Controller' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'system' => ['error' => ['email' => 'vottus@vott.us', 'presenter' => 'Error']],
			'database' => [
				'driver' => 'pdo_mysql',
				'port' => 3306,
				'host' => 'localhost',
			...
			'appDir' => '/home/vottusuwu/Desktop/asv/app',
			'wwwDir' => '/home/vottusuwu/Desktop/asv/public',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/home/vottusuwu/Desktop/asv/app/../temp',
			'rootDir' => '/home/vottusuwu/Desktop/asv',
		];
	}
	...
	public function createServiceApi__core__schema(): Apitte\Core\Schema\Schema
	{
		return $this->getService('api.core.schema.hydrator')->hydrate([
			[
				...
				'responses' => [],
				'negotiations' => [],
				'attributes' => ['pattern' => '/api/v2/users'],
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/vottusuwu/Desktop/asv/app/../temp/cache/nette.application/touch'
		));
	...
	public function createServiceContainer(): Container_4a548d3fe8
	{
		return $this;
	}
	...
	{
		return new App\Model\Api\Middleware\AuthenticationMiddleware(
			new App\Model\Api\Security\TokenAuthenticator($this->getService('nettrine.orm.entityManagerDecorator')),
	...
	{
		return new Monolog\Handler\RotatingFileHandler('/home/vottusuwu/Desktop/asv/app/../log/syslog.log', 30, 300);
	}
	...
	{
		return new Doctrine\Common\Cache\PhpFileCache('/home/vottusuwu/Desktop/asv/app/../temp/cache/nettrine.cache');
	}
	...
	{
		return new Nettrine\Fixtures\Loader\FixturesLoader(['/home/vottusuwu/Desktop/asv/db/Fixtures'], $this);
	}
	...
	public function createServiceNettrine__migrations__configuration(): Nettrine\Migrations\ContainerAwareConfiguration
	{
		...
		$service->setMigrationsDirectory('/home/vottusuwu/Desktop/asv/db/Migrations');
	...
	public function createServiceNettrine__orm__annotations__annotationDriver(): Doctrine\ORM\Mapping\Driver\AnnotationDriver
	{
		...
		$service->addPaths(['/home/vottusuwu/Desktop/asv/app/model/Database/Entity']);
		return $service;
	}
	...
	public function createServiceNettrine__orm__configuration(): Doctrine\ORM\Configuration
	{
		...
		$service->setProxyDir('/home/vottusuwu/Desktop/asv/app/../temp/proxies');
	...
	public function createServiceSymfony__serializer__annotationLoader(): Symfony\Component\Serializer\Mapping\Loader\AnnotationLoader
	{
		return new Symfony\Component\Serializer\Mapping\Loader\AnnotationLoader(new Doctrine\Common\Annotations\CachedReader(
			...
			new Doctrine\Common\Cache\FilesystemCache('/home/vottusuwu/Desktop/asv/app/../temp/cache/Symfony.Serializer')
		));
	}
	...
	public function createServiceSymfony__validator__builder(): Symfony\Component\Validator\ValidatorBuilder
	{
		return Symfony\Component\Validator\Validation::createValidatorBuilder()->enableAnnotationMapping(new Doctrine\Common\Annotations\CachedReader(
			$this->getService('symfony.serializer.annotationReader'),
			new Doctrine\Common\Cache\FilesystemCache('/home/vottusuwu/Desktop/asv/app/../temp/cache/Symfony.Validator')
		));
	}
	...
	public function initialize()
	{
		...
		(function () {
			...
			Tracy\Debugger::$email = 'vottus@vott.us';
