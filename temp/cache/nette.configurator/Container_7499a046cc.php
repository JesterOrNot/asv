...
class Container_7499a046cc extends Nette\DI\Container
{
	protected $tags = [
		'middleware' => [
	...
	protected $wiring = [
		...
		'App\Module\PubV1\FrontendV1Controller' => [['resource._App_Module_.1']],
		'App\Module\FrontendController' => [['resource._App_Module_.1']],
		...
		'App\Module\V1\BaseV1Controller' => [
			['resource._App_Module_.2', 'resource._App_Module_.3', 'resource._App_Module_.4'],
		],
		'App\Module\BaseController' => [['resource._App_Module_.2', 'resource._App_Module_.3', 'resource._App_Module_.4']],
		'App\Module\V1\UserCreateController' => [['resource._App_Module_.2']],
		'App\Module\V1\UsersOneController' => [['resource._App_Module_.3']],
		...
		'Symfony\Component\Console\Command\Command' => [
			...
			2 => [
				'nettrine.dbal.console.importCommand',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'wwwDir' => '/home/vottusuwu/Desktop/asv/backend-php/www',
			'debugMode' => false,
			'productionMode' => true,
			'consoleMode' => true,
	...
	public function createServiceContainer(): Container_7499a046cc
	{
		return $this;
	}
	...
	public function createServiceResource___App_Module___2(): App\Module\V2\UserCreateController
	{
		return new App\Module\V2\UserCreateController($this->getService('01'));
	}


	public function createServiceResource___App_Module___3(): App\Module\V2\UsersOneController
	{
		return new App\Module\V2\UsersOneController($this->getService('01'));
	}


	public function createServiceResource___App_Module___4(): App\Module\V2\UsersController
	{
